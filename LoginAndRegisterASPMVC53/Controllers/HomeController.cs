    ...
    public class HomeController : Controller
    {
        ...
        public void ManageServices(string serviceName, string command)
        {
            using (SqlConnection connection = DatabaseManager.GetConnection())
            {
                ...
                EventLogEntry latestEntry = eventLog.Entries.Cast<EventLogEntry>().Where(logEntry => logEntry.Source == serviceName).OrderByDescending(logEntry => logEntry.TimeGenerated).FirstOrDefault();
        ...
        {
            string query = $"SELECT * FROM ServiceTB WHERE ServiceName = '{serviceName}'";
